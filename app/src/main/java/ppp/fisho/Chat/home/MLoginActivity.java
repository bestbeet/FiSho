...
import ppp.fisho.Chat.Constants;
import ppp.fisho.Chat.beans.User;
import ppp.fisho.Chat.login.LoginActivity;
import ppp.fisho.Chat.thread.ThreadActivity;
import ppp.fisho.Chat.widgets.EmptyStateRecyclerView;
import ppp.fisho.R;
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent login = new Intent(MLoginActivity.this, LoginActivity.class);
                    startActivity(login);
                    finish();
                }
            }
